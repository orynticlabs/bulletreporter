const en = {
  ...
  home: {
    ...
    retry: 'Retry',
    loadingBreaking: 'Loading breaking news...',
  ...
  news: {
    ...
    noNewsAvailable: 'No news available right now',
    loadingNews: 'Loading news...',
    errorLoading: 'Problem loading news',
    retry: 'Retry',
    views: 'Views',
    readTime: 'Read time',
    author: 'Author',
  ...
  newsDetail: {
    ...
    noMoreArticles: 'No more articles available',
    loadingMore: 'Loading...',
